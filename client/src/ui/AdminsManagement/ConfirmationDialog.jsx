...
const ConfirmationDialog = ({ isOpen, onClose, onConfirm, title, message }) => {
  ...
  return (
    ...
    >
      <div
        ref={dialogRef}
        className="w-full max-w-sm bg-[var(--bg-secondary)] rounded-xl border border-[var(--border-color)] shadow-lg p-6 mx-4"
      ...
      >
        <div className="text-center">
          ...
          <div className="flex gap-3">
            <button
              onClick={onClose}
              className="flex-1 px-4 py-2.5 text-sm font-medium text-[var(--text-secondary)] border border-[var(--border-color)] rounded-lg hover:bg-[var(--bg-tertiary)] focus:outline-none focus-visible:ring-2 focus-visible:ring-teal-400 focus-visible:ring-offset-1 transition-colors duration-150 cursor-pointer"
            >
              Cancel
            </button>
            <button
